class CaixaDaLanchonete {
    ...
    calcularValorDaCompra(formaPagamento, itens) {
        ...
        // Validações básicas da compra
        if (itens.length === 0) return "Não há itens no carrinho de compra!";
        if (!['debito', 'credito', 'dinheiro'].includes(formaPagamento)) return "Forma de pagamento inválida!";
        ...
        // Aplicação dos descontos ou taxas de acordo com forma de pagamento
